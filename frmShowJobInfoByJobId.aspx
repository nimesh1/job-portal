        ...
        <table border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="width: 100px; height: 86px;">
                    <asp:DetailsView ID="DetailsView1" runat="server" Height="64px" Width="331px" BorderColor="#E3E7E3" Font-Bold="True" Font-Size="Medium" OnPageIndexChanging="DetailsView1_PageIndexChanging">
                    </asp:DetailsView>
                </td>
            </tr>
        </table>
