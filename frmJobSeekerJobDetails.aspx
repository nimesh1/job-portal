<%@ Page Language="C#" MasterPageFile="~/JobSeeker/MasterPage.master" AutoEventWireup="true"
    CodeFile="frmJobSeekerJobDetails.aspx.cs" Inherits="JobSeeker_Registration_frmJobSeekerJobDetails"
    Title="Untitled Page" %>
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 424px">
        ...
        <tr style="font-size: 12pt">
            <td align="center" colspan="4">
                <span style="color: #ffffff"><strong style="font-weight: bold; color: #ff0000">* Fields
                    Are Mandatory</strong></span>
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="center" colspan="4">
        ...
        <tr style="font-size: 12pt">
            <td align="center" colspan="4" style="font-size: 14pt; color: #006600; text-decoration: underline;
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 144px;">
                <strong style="font-weight: bold; color: #006600">Job Category:</strong>
            </td>
            ...
            <td align="left" colspan="2">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlJobType"
                    ErrorMessage="*" ValidationGroup="g1" InitialValue="---Select---">*</asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="center" colspan="4">
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; text-align: center;
                width: 144px;">
                <strong><span style="font-size: 14pt; font-weight: bold; color: #006600;">First Choice
                    <span style="color: #ff3333">*</span></span></strong>
            </td>
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; text-align: center;
                width: 9px;">
            </td>
            <td align="left" colspan="2" style="font-size: 14pt; text-align: center">
                <span style="color: #ffffff"><strong style="font-weight: bold; color: #006600">Second
                    Choice</strong></span>
            </td>
        </tr>
        <tr style="font-size: 12pt">
                    ...
                    <tr>
                        ...
                        <td style="width: 100px">
                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlCountry1" runat="server" Width="122px" AutoPostBack="True"
                                        OnSelectedIndexChanged="ddlCountry1_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <span style="color: #ffcc33"></span>
                                    <asp:DropDownList ID="ddlState1" runat="server" Width="122px" 
                                        AutoPostBack="True" OnSelectedIndexChanged="ddlState1_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="ddlCity1" runat="server" Width="122px">
                                    </asp:DropDownList>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="ddlCountry1"
                    ...
                    <tr>
                        ...
                        <td style="width: 100px">
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                <ContentTemplate>
                                    <asp:DropDownList ID="ddlCountry2" runat="server" Width="122px" AutoPostBack="True"
                                        OnSelectedIndexChanged="ddlCountry2_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="ddlState2" runat="server" Width="122px" AutoPostBack="True"
                                        OnSelectedIndexChanged="ddlState2_SelectedIndexChanged">
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="ddlCity2" runat="server" Width="122px">
                                    </asp:DropDownList>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
        ...
        <tr style="font-size: 12pt">
            <td align="center" colspan="4" style="font-size: 12pt; color: #ffffff">
                <asp:CheckBox ID="chkWillingRelocate" runat="server" Text="Willing To Relocate" Font-Bold="True"
                    ForeColor="#006600" />
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="center" colspan="4" style="font-size: 12pt; color: #ffffff">
                &nbsp; &nbsp; &nbsp;&nbsp;
                <asp:CheckBox ID="chktelecommute" runat="server" Text="Willing To Telecommute" Font-Bold="True"
                    ForeColor="#006600" />
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 144px;">
                <strong style="font-weight: bold; color: #006600">Willing To Travel Upto:</strong>
            </td>
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 9px;">
                <span style="color: #ff0000; font-weight: bold;">*</span>
            </td>
        ...
        <tr style="font-size: 12pt">
            <td align="center" colspan="5" style="font-size: 14pt; color: #006600; text-decoration: underline;
                font-weight: bold; text-align: left;">
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 144px;">
                <strong style="font-weight: bold; color: #006600">Salary as Full-Time-Employee:</strong>
            </td>
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 9px;">
                <span style="color: #ff0000; font-weight: bold;">*</span>
            </td>
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 144px;
                height: 71px;">
                <strong style="font-weight: bold; color: #006600">Hourly Rate for Contact:</strong>
            </td>
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 9px;
                height: 71px;">
                <span style="color: #ff0000; font-weight: bold;">*</span>
            ...
            <td align="left" colspan="3" style="font-size: 12pt; color: #ffffff; height: 71px;">
                <asp:DropDownList ID="ddlPartTimeSalary" runat="server" Width="122px" ValidationGroup="g1"
                    Height="144px">
                    <asp:ListItem Value="---select---">---select---</asp:ListItem>
        ...
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 144px;">
                <strong style="font-weight: normal; color: #006600"><strong>Type Of Employment:</strong><br />
                    (You must Specify atleast One)</strong>
            </td>
            <td align="left" colspan="1" style="font-size: 12pt; color: #ffffff; width: 9px;">
                <span style="color: #ff0000; font-weight: bold;">*</span>
            </td>
            <td align="left" colspan="3" style="font-size: 12pt; color: #006600; font-weight: normal;">
                <asp:ListBox ID="lstEmploymentType" runat="server" Height="69px" Width="183px" ValidationGroup="g1"
        ...
        <tr style="font-size: 12pt">
            <td align="center" colspan="4" style="font-size: 12pt; color: #ffffff">
                <asp:Label ID="lblMsg" runat="server" Font-Bold="True" Font-Size="13pt" Width="312px"
