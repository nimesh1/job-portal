...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center" border="0" cellpadding="0" cellspacing="0" style="width: 508px">
        ...
        <tr>
            <td align="left" colspan="4" style="font-size: 12pt; color: #ffffff; height: 16px;">
                Job Name:&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtJobName" runat="server" OnTextChanged="txtJobName_TextChanged"></asp:TextBox>
            </td>
        </tr>
        <tr style="font-size: 12pt">
            <td align="left" colspan="1" style="font-size: 12pt; width: 191px; color: #ffffff">
                <strong><span style="color: darkblue">Job ID:</span></strong></td>
        ...
        <tr style="font-size: 12pt; color: #ffcc00">
            ...
            <td align="left" colspan="2" style="color: #ffcc00">
                <asp:TextBox ID="txtSkills" runat="server" ValidationGroup="g1" Width="189px" 
                    ></asp:TextBox>
