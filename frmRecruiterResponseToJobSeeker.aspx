    ...
    <table id="TABLE1" border="0" cellpadding="0" cellspacing="0" language="javascript"
        ...
        <tr>
            <td colspan="2" align="center">
                <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Job Found" OnPageIndexChanging="GridView1_PageIndexChanging" Width="669px" AutoGenerateColumns="False" OnRowCommand="GridView1_RowCommand" Font-Size="Small" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
